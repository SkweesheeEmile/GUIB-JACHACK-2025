...
function Forms() {
  ...
  return (
    <div>
      ...
      <p>
        Do you use other source of energy other than the one provided by the
        city?
      </p>
      <label>
        <input
      ...
      <h3>Awareness</h3>
      <p>
        Do you make sure that there is only the lights needed open in your
        house?
      </p>
      <label>
        <input
      ...
      <br />
      <p>
        Do you make sure to use as little as possible the AC and the heater of
        your house?{" "}
      </p>
      <label>
        <input
